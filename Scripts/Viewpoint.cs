...
namespace EvolveGames
{
    public class Viewpoint : MonoBehaviour
    {
        ...
        void Start()
        {
            ImageUI = Instantiate(ImagePrefab, FindObjectOfType<Canvas>().transform);
        ...
        void Update()
        {
            ...
            if(ViewObject.GetComponent<ViewCheck>().CheckedBool() == false)
            {
                ImageUI.gameObject.SetActive(false);
            }
            else { ImageUI.gameObject.SetActive(true);}
