...
namespace EvolveGames
{
    public class ItemChange : MonoBehaviour
    {
        ...
        bool ItemChangeLogo;
        [SerializeField] private Image KeyLogo;
        [SerializeField] private GameObject KeyLogoBtn;
        [SerializeField] private Sprite[] KeySpriteLogo;
        private void Start()
        {
        ...
        IEnumerator ItemLogoChange()
        {
            ...
            if (ItemIdInt == 0)
            {
                KeyLogoBtn.SetActive(true);
            }
            else
            {
                KeyLogoBtn.SetActive(false);
            }
            yield return new WaitForSeconds(0.5f);
